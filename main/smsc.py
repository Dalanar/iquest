...
SMSC_LOGIN = "iquest"            # логин клиента
SMSC_PASSWORD = "129e4722f5642c4b744279467264f0db"    # пароль или MD5-хеш пароля в нижнем регистре
...
# Examples:
# smsc = SMSC()
# smsc.send_sms("79069496553", "Привет! Квест готов, епт!", sender="iquest")
